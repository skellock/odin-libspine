...
odin_output << '    foreign import lib { "macos/libspine-c.a", "macos/libspine-cpp.a", "system:c++" }'
odin_output << '} else when ODIN_OS == .Linux {'
odin_output << '    foreign import lib { "linux-x86_64/libspine-c.a", "linux-x86_64/libspine-cpp.a", "system:stdc++" }'
odin_output << '}'
odin_output << ''
